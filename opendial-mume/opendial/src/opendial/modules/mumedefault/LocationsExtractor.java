...
import opendial.modules.mumedefault.information.City;
import opendial.modules.mumedefault.information.LocationInfo;
import opendial.modules.mumedefault.information.Slot;
            ...
            do {
                ...
                for (LocationInfo city : cities) {
                    if (newStartCity == null && START_VERBS.contains(city.getFirstVerbGovernorLemma()) && !city.isEnd) {
                        newStartCity = city;
                        city.isStart = true;
                    } else if (newEndCity == null && LOCATION_END_VERBS.contains(city.getFirstVerbGovernorLemma()) && !city.isStart) {
                        newEndCity = city;
                        city.isEnd = true;
                    }
                    ...
                    if (newStartCity == null &&
                            ...
                            !LOCATION_END_VERBS.contains(city.getFirstVerbGovernorLemma()) &&
                            !city.isEnd) {
                        newStartCity = city;
                        city.isStart = true;
                    }
                ...
                for (LocationInfo address : addresses) {
                    if (newStartAddress == null && START_VERBS.contains(address.getFirstVerbGovernorLemma()) && !address.isEnd) {
                        newStartAddress = address;
                        address.isStart = true;
                    } else if (newEndAddress == null && LOCATION_END_VERBS.contains(address.getFirstVerbGovernorLemma()) && !address.isStart) {
                        newEndAddress = address;
                        address.isEnd = true;
                    }
                    ...
                    if (newStartAddress == null &&
                            ...
                            !LOCATION_END_VERBS.contains(address.getFirstVerbGovernorLemma()) &&
                            !address.isEnd) {
                        newStartAddress = address;
                        address.isStart = true;
                    }
                ...
                for (LocationInfo slot : slots) {
                    if (newStartSlot == null && START_VERBS.contains(slot.getFirstVerbGovernorLemma()) && !slot.isEnd) {
                        newStartSlot = slot;
                        slot.isStart = true;
                    } else if (newEndSlot == null && LOCATION_END_VERBS.contains(slot.getFirstVerbGovernorLemma()) && !slot.isStart) {
                        newEndSlot = slot;
                        slot.isEnd = true;
                    }
                    /* Ho bisogno di una macchina di Nichelino */
                    if (newStartSlot == null &&
                            ...
                            !LOCATION_END_VERBS.contains(slot.getFirstVerbGovernorLemma()) &&
                            !slot.isEnd) {
                        newStartSlot = slot;
                        slot.isStart = true;
                    }
